...
import Image from 'next/image'; // Pakai Image component
import { ArrowRight } from 'lucide-react';
import { beritaData } from '@/data/content'; // Import data

export default function BeritaPage() {
  return (
    <div className="container mx-auto px-4 py-12 min-h-screen">
      <h1 className="text-3xl font-bold text-gray-900 text-center mb-12">Berita</h1>

      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
        {beritaData.map((item) => (
          <Link key={item.kode} href={`/berita/${item.kode}`} className="group block h-full">
